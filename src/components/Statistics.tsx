...
import { motion, useInView, useSpring, Spring } from 'framer-motion';
...
const Statistics = () => {
  ...
  const cardColorClasses: { [key: string]: string } = {
    indigo: 'from-indigo-50 to-purple-50 dark:from-indigo-900/30 dark:to-purple-900/30 hover:border-indigo-500',
    pink: 'from-pink-50 to-rose-50 dark:from-pink-900/30 dark:to-rose-900/30 hover:border-pink-500',
    amber: 'from-amber-50 to-orange-50 dark:from-amber-900/30 dark:to-orange-900/30 hover:border-amber-500',
  };
